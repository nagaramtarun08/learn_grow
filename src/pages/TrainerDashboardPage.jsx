...
import { PlusCircle, Edit3, Users, BarChart2, FileText } from 'lucide-react';
      ...
      <div className="container mx-auto">
        ...
        >
          <Card className="glassmorphism">
            ...
            <CardContent>
              ...
              <Button className="mt-4 bg-gradient-to-r from-blue-500 to-sky-500 text-white hover:opacity-90" onClick={() => navigate('/create-course')}>
        ...
        >
          <DashboardActionCard
            ...
            description="Upload PDFs, videos, and audio for your courses."
